#!/bin/bash
MPICC="/home/gavahi/boringssl-mpich.3.2.1/install_mpich/bin/mpicc"
MPIEXEC="/home/gavahi/boringssl-mpich.3.2.1/install_mpich/bin/mpiexec" 
export LD_LIBRARY_PATH=/home/gavahi/boringssl-mpich.3.2.1/install_mpich/lib:/home/gavahi/boringssl-master/build/crypto
RED='\033[0;32m'
NC='\033[0m' # No Color
printf "\n${RED}#######################################################  New Test  ##############################################################################${NC}\n"
